...
pub struct LatestPriceRequestRepr {
    ...
    pub channel: Channel,
    /// If specified, only an update corresponding to one of specified market sessions will be returned.
...
pub struct SubscriptionParamsRepr {
    ...
    /// List of market sessions to receive updates for. If none are specified, only regular session
