...
/// funding_rate, ema_price, ema_confidence) are decoded from LE two's complement
/// u64 on the wire.
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct Feed {
    pub feed_id: u32,
...
fn parse_feed(reader: &mut Reader) -> Result<Feed, ContractError> {
    ...
    for _ in 0..num_properties {
        ...
        match property_id {
            ...
            11 => {
                // EmaConfidence: u64 on wire, reinterpret as i64; 0 = absent
                feed.ema_confidence = read_optional_i64(reader)?;
            }
            12 => {
